...
db["User"].findOne({where: {email: "admin@groupomania.com"}}).then((user) => {
	if (user == null) {
		db["User"]
			.bulkCreate([
				{
			...
			.then((data) => {
				...
				db["Article"]
					.bulkCreate([
						...
						{
							id: 4,
							text: "Pour commencer la semaine en musique !",
							youtube: "https://www.youtube.com/watch?v=OPf0YbXqDm0",
							createdAt: "2021-08-07 10:29:29",
							updatedAt: "2021-08-07 10:29:29",
							UserId: 9,
						},
					])
					.then(() => {
						db["Comment"].bulkCreate([
                            ...
                            {
                                id: 4,
                                text: "Belle semaine à vous également",
                                createdAt: "2021-08-07 10:30:33",
                                updatedAt: "2021-08-07 10:30:33",
                                ArticleId: 1,
                                UserId: 9,
                            },
						])
			...
			.catch((error) => console.log("***************** Erreur insertion **********************", error))
	}
})
